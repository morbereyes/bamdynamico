...
Write-Host "";
Write-Host "";
Write-Host -ForegroundColor Magenta " Cargando BAM - morbe  (no te estamos hackeando :V) discord.gg/dynamicpvp" -NoNewLine
Write-Host -ForegroundColor White "..;#SS%%%%%S#+;;;;,...... ";
Write-Host -ForegroundColor White "..%S%%%%?*%?:::::;**:.... ";
Write-Host -ForegroundColor White ".;#%%%%%?%?.......,;**;.. ";
Write-Host -ForegroundColor White ".%S%%%%?%S;;;;;,.....:**; ";
Write-Host -ForegroundColor White ";#%%%%?%@@@@@@@S+,....,;S ";
Write-Host -ForegroundColor White "SS%%%??#@@@@@@@@@;....,+? ";
Write-Host -ForegroundColor White "+?%%%%???@@@@@@@#,....:?+ ";
Write-Host -ForegroundColor White "..,%S%??#@@@@@@S+....,:%, ";
Write-Host -ForegroundColor White "...S%??S%%%%%?:......,+%. ";
Write-Host -ForegroundColor White "..:#?%%:..........,;+*+,. ";
...
if (!(Test-Admin)) {
    Write-Warning "ejecutalo como admin mongol"
    Start-Sleep 10
    Exit
}
...
Catch{
    Write-Warning "Error leyendo BAM. Probablemente esta version de Windows"
    Exit
}
